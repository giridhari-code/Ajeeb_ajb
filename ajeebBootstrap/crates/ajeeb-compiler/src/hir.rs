...
impl HirType {
    ...
    pub fn is_compatible_with(&self, other: &HirType) -> bool {
        ...
        match (self, other) {
            ...
            (HirType::Named(n), HirType::Fn { .. }) | (HirType::Fn { .. }, HirType::Named(n)) if n == "function" => true,
            (HirType::Fn { params: p1, ret: r1 }, HirType::Fn { params: p2, ret: r2 }) => {
                p1.len() == p2.len() && p1.iter().zip(p2).all(|(a, b)| a.is_compatible_with(b))
