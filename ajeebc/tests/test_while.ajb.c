...
block_1: // ic=3
    // #0 op=2 d=1 s1=3 s2=0 e=1
    t1 = 3;
    // #1 op=2 d=2 s1=0 s2=1 e=7
    t2 = t0 < t1;
    // #2 op=7 d=2 s1=2 s2=3 e=0
    if (t2) { goto block_2; } else { goto block_3; }

block_2: // ic=6
    // #0 op=4 d=4 s1=79 s2=4 e=1
    t4 = itoa(t0);
    // #1 op=4 d=3 s1=71 s2=7 e=5
    t3 = println(t4);
    // #2 op=2 d=5 s1=1 s2=0 e=1
    t5 = 1;
    // #3 op=2 d=6 s1=0 s2=5 e=1
    t6 = t0 + t5;
    // #4 op=2 d=0 s1=6 s2=0 e=101
    t0 = t6;
